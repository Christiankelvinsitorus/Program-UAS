...
main()
{
   ...
   cout<<"=============================================================================\n";
   cout<<"     | 1. |          Travel Bag Diesel Misty         |    [D]      |\n";
   cout<<"     | 2. |     Mini Backpack Pattern by JJ Bags     |    [B]      |\n";
   cout<<"     | 4. |   Sepatu Pria Diesel House Mix Colour    |    [H]      |\n";
   cout<<"     | 5. |        Slip On APC by Adorable JJ        |    [S]      |\n";
   cout<<"     | 6. |     Washed Jeans Streched Dark Blue      |    [W]      |\n";
   cout<<"     | 7. |   Celana Panjang Wanita Kulot JJ Jeans   |    [J]      |\n";
   cout<<"     | 8. |     Blouse Sleeveless Patch Long Top     |    [L]      |\n";
   cout<<"     | 9. |      Jaket Bomber Pria Multi Pocket      |    [M]      |\n";
   cout<<"     | 10.|         Gamis Anak by Kids Smile         |    [G]      |\n";
   cout<<"=============================================================================\n";
   cout<<endl;
   for(i=1;i<=j;i++)
   {
   ...
   if(kode_brg[i]=='D'||kode_brg[i]=='d')
      {
      barang[i]="Travel Bag Diesel Misty";
      harga[i]=150900;
      }
      else if(kode_brg[i]=='B'||kode_brg[i]=='b')
      {
      barang[i]="Mini Backpack Pattern by JJ Bags";
      harga[i]=149900;
      }
      else if(kode_brg[i]=='H'||kode_brg[i]=='h')
      {
      barang[i]="Sepatu Pria Diesel House Mix Colour";
      harga[i]=239900;
      }
      else if(kode_brg[i]=='S'||kode_brg[i]=='s')
      {
      barang[i]="Slip On APC by Adorable JJ";
      harga[i]=259900;
      }
      else if(kode_brg[i]=='W'||kode_brg[i]=='w')
      {
      barang[i]="Washed Jeans Streched Dark Blue";
      harga[i]=329900;
      }
      ...
      {
      barang[i]="Blouse Sleeveless Patch Long Top";
      harga[i]=169900;
      }
      else if(kode_brg[i]=='M'||kode_brg[i]=='m')
      {
      barang[i]="Jaket Bomber Pria Multi Pocket";
      harga[i]=279900;
      }
      else if(kode_brg[i]=='G'||kode_brg[i]=='g')
      {
      barang[i]="Gamis Anak by Kids Smile";
      harga[i]=129900;
      }
      else
      {
